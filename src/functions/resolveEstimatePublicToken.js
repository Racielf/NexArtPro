...
async function buildResponse(estimate, base44) {
  ...
  return json({
    estimate: {
      ...
      company_signature_name: estimate.company_signature_name || '',
      company_signature_email: estimate.company_signature_email || '',
      company_signature_role: estimate.company_signature_role || '',
      company_signed_at: estimate.company_signed_at || '',
