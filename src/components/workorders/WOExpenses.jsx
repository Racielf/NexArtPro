...
export default function WOExpenses({ workOrderId, workOrderNumber }) {
  ...
  const loadExpenses = async () => {
    const data = await nexartClient.entities.WorkOrderExpense.filter({ work_order_id: workOrderId });
    setExpenses(data);
    setLoading(false);
  };
  ...
  const handleAdd = async () => {
    ...
    setSaving(true);
    await nexartClient.entities.WorkOrderExpense.create({
      ...form,
  ...
  const handleDelete = async (expId) => {
    ...
    await archiveWithSnapshot(nexartClient.entities.WorkOrderExpense, 'WorkOrderExpense', expId, actor, 'Deleted by user');
