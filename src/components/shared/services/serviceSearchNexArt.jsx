/**
 * serviceSearchNexArt.js — Searches the NexArt Service entity for matching services.
...
/**
 * Search NexArt Service entity records.
 * Returns results compatible with SmartServicePicker.
 */
export async function searchNexArtServices(query, limit = 8) {
  const q = norm(query);
  if (!q) return [];
 ...
 */
export function invalidateNexArtServiceCache() {
  _cache = null;
  _cacheTime = 0;
}