...
export default function InvoiceDetailClean() {
  ...
  const [payForm,  setPayForm]  = useState({ amount: "", method: "cash", notes: "", paid_at: format(new Date(), "yyyy-MM-dd") });
  ...
  const handleRecordPayment = async (e) => {
    ...
    setSaving(true);
    try {
      const payments = [...(invoice.payments || []), { id: crypto.randomUUID(), amount, method: payForm.method, notes: payForm.notes, paid_at: payForm.paid_at, created_at: new Date().toISOString() }];
          ...
          <form onSubmit={handleRecordPayment} className="space-y-4 pt-2">
            <div>
              ...
              <input
                ...
                placeholder={`Balance: ${formatCurrency(derived.balance_due)}`}
