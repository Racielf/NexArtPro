...
export default function Clients() {
  ...
  const loadClients = async () => {
    setLoading(true);
    const data = await nexartClient.entities.Client.list('-created_date');
  ...
  const handleSave = async () => {
    ...
    if (editing) {
      await nexartClient.entities.Client.update(editing.id, form);
      toast.success('Client updated');
    } else {
      await nexartClient.entities.Client.create(form);
  ...
  const handleDelete = async (id) => {
    ...
    await archiveWithSnapshot(nexartClient.entities.Client, 'Client', id, actor);
  ...
  const handleConfirmDelete = async (reason) => {
    ...
    await archiveManyWithSnapshot(nexartClient.entities.Client, 'Client', idsArray, actor, reason);
    setSelectedIds(new Set());
