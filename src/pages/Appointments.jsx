...
export default function Appointments() {
  ...
  const loadData = async () => {
    ...
    const [appts, custs, ws] = await Promise.all([
      nexartClient.entities.Appointment.list('-appointment_date'),
      nexartClient.entities.Customer.list('-created_date'),
  ...
  const handleSave = async (form) => {
    ...
    if (editing) {
      await nexartClient.entities.Appointment.update(editing.id, form);
      saved = { ...editing, ...form };
      ...
      saved = await nexartClient.entities.Appointment.create(form);
  ...
  const handleStatusChange = async (id, newStatus) => {
    ...
    await nexartClient.entities.Appointment.update(id, { status: newStatus, ...extra });
