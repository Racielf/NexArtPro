...
export default function Proposals() {
  ...
  const load = async () => {
    ...
    const [props, ests] = await Promise.all([
      nexartClient.entities.Proposal.list('-created_date'),
  ...
  const handleClientSelected = async (client) => {
    ...
    const created = await nexartClient.entities.Proposal.create({
      proposal_number: num,
      status: 'draft',
  ...
  const handleConfirmArchive = async (reason) => {
    ...
    await archiveWithSnapshot(nexartClient.entities.Proposal, 'Proposal', p.id, actor, reason);
  ...
  const handleDeleteSelected = async (reason) => {
    ...
    await archiveManyWithSnapshot(nexartClient.entities.Proposal, 'Proposal', idsArray, actor, reason);
