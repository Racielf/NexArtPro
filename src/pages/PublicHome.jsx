...
export default function PublicHome() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await nexartClient.functions.invoke('submitContactForm', formData);
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: 'url(https://media.nexartClient.com/images/public/69cc888bb34befdf803a06b0/09739ac11_image.png)',
