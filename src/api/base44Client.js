 ...
 *
 * Usage (identical to the old Base44 pattern):
 *   import { base44 } from '@/api/base44Client';
 *   const items = await base44.entities.Estimate.list('-created_date', 100);
 *   const filtered = await base44.entities.Invoice.filter({ client_id: 'abc' });
...
// ─── Table name mapping ───────────────────────────────────────────
// Maps Base44 entity names → Supabase table names (snake_case plural)
const TABLE_MAP = {
...
// ─── Filter builder ───────────────────────────────────────────────
// Converts Base44 filter objects to Supabase .eq/.in/.gte/etc. chains
...
// ─── Entity proxy ─────────────────────────────────────────────────
// Creates entity instances on-the-fly: base44.entities.Estimate → new SupabaseEntity('Estimate')
const entityCache = {};
